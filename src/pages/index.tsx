...
export default function Home({ sections }: Props) {
  ...
  return (
    <>
      ...
      <Navigation menuItems={sections.slice(0, -1)} logoSrc={logo.src} />
      <Box
        as="main"
        display="flex"
        flexDir="column"
